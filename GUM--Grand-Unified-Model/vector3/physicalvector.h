...
public:
  ...
  static vector3& operator* (vector3 leftside, const double &var);
  static vector3& operator* (const double& var, vector3 rightside);
  static vector3& operator / (vector3 leftvector, const double &var);
  static vector3& operator- (vector3 leftvector, const vector3 &rightvector);
  static vector3& operator+ (vector3 leftsidevector, const vector3 &rightsidevector);
